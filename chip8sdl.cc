...
void Chip8SDL::c8d_initialize() {
  ...
  window = SDL_CreateWindow("chip8em", SDL_WINDOWPOS_UNDEFINED,
                            SDL_WINDOWPOS_UNDEFINED, sc_width, sc_height,
                            SDL_WINDOW_SHOWN);
  if (window == NULL) {
...
bool Chip8SDL::c8d_check_if_key(u8 key) { return keystate[keys[key]]; }
